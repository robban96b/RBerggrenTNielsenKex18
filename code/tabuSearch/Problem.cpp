...
Problem::Problem( std::istream& ifs ) {
  ...
  ifs >> n_of_events;
  //std::cout << "n_of_events: " << n_of_events << std::cout;
  ifs >> n_of_rooms;
  //std::cout << "n_of_rooms: " << n_of_rooms << std::cout;
  ifs >> n_of_features;
  //std::cout << "n_of_features: " << n_of_features << std::cout;
  ifs >> n_of_students;
  //std::cout << "n_of_students: " << n_of_students << std::cout;
  ...
  /*for (int i = 0; i < n_of_events; i++) {
    std::cout << "Event " << i << ", nr_of_stud: " << studentNumber[i] << std::cout;
    }*/
